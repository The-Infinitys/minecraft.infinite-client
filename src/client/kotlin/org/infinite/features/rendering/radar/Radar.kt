...
class Radar : ConfigurableFeature(initialEnabled = false) {
    ...
    fun findTargetMobs(): List<LivingEntity> {
        ...
        val radiusSetting = getSetting("Radius") as? FeatureSetting.IntSetting
        val heightSetting = getSetting("Height") as? FeatureSetting.IntSetting
...
object RadarRenderer {
    ...
    fun render(
        ...
        val marginPercent = (radarFeature.getSetting("Margin") as? FeatureSetting.IntSetting)?.value ?: 4
        val sizePercent = (radarFeature.getSetting("Size") as? FeatureSetting.IntSetting)?.value ?: 10
