package org.theinfinitys.features.rendering.tag
...
class HyperTag : ConfigurableFeature(initialEnabled = false) {
    ...
    private val mobs = InfiniteSetting.BooleanSetting("Mobs", "Show Mob Info", true)
    private val players = InfiniteSetting.BooleanSetting("Players", "Show Player Info", true)
    private val distance = InfiniteSetting.IntSetting("Distance", "Display Distance (0 to Unlimited)", 64, 0, 256)
