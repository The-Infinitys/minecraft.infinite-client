package org.theinfinitys.features.fighting.gun
...
class Gunner : ConfigurableFeature(initialEnabled = false) {
    private val fireMode: InfiniteSetting.EnumSetting<FireMode> =
    ...
    private val fastReload: InfiniteSetting.BooleanSetting =
        InfiniteSetting.BooleanSetting(
            "FastReload",
            "If enabled, reloading become fast",
            false,
        )
    private val changeMode: InfiniteSetting.EnumSetting<ChangeMode> =
        InfiniteSetting.EnumSetting(
            "ChangeMode",
    ...
    private val additionalInterval: InfiniteSetting.IntSetting =
        InfiniteSetting.IntSetting("AdditionalInterval", "Additional interval for full-auto", 3, 0, 10)
    override val settings: List<InfiniteSetting<*>> = listOf(fireMode, fastReload, changeMode, additionalInterval)
