...
public final class TextRenderState extends TextGuiElementRenderState
  ...
  @Nullable public final ScreenRect clipBounds;
  @Nullable private TextRenderer.GlyphDrawable preparation;
  @Nullable private ScreenRect bounds;
    ...
    if (this.preparation == null) {
      ...
      this.preparation =
          this.textRenderer.prepare(
              this.orderedText, this.x, this.y, this.color, this.shadow, this.backgroundColor);
      ScreenRect screenRect = this.preparation.getScreenRect();
      if (screenRect != null) {
        screenRect = screenRect.transformEachVertex(this.matrix);
        this.bounds =
            this.clipBounds != null ? this.clipBounds.intersection(screenRect) : screenRect;
      }
    }
